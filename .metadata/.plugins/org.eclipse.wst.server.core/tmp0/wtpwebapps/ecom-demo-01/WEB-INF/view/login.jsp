  ...
  <div class="login-container">
    ...
    <form id="login-form" action="validateUser" method=GET>
      ...
      <div class="form-group">
        ...
        <input type="password" id="password" name="txtPwd" placeholder="Enter your password" required>
        <div class="error-message" id="password-error"></div>
      </div>
			<div class="buttons-container">
        <button class="form-group" type="submit">Login</button>
        <button class="form-group" type="button" onclick="window.location.href='${pageContext.request.contextPath}/user/showRegistrationForm';">Register</button>
      </div>
    </form>
  </div>
