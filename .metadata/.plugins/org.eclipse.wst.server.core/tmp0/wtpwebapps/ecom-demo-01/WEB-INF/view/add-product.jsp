  ...
  <div class="container">
    ...
    <form action="insertProduct" method = "POST" enctype="multipart/form-data">
      ...
      <div class="form-group file-input">
        ...
        <input type="file" accept="" id="uploadImage" name="uploadImage" onchange="displayImageName(event)">
      ...
      <div class="form-group">
        ...
        <div class="section-select">
          <div class="section-option">
            <input type="radio" id="all" name="section" value="All" required>
            <label for="all">All</label>
          </div>
          <div class="section-option">
            <input type="radio" id="men" name="section" value="Men" required>
            <label for="men">Men</label>
          </div>
          <div class="section-option">
            <input type="radio" id="women" name="section" value="Women" required>
            <label for="women">Women</label>
          </div>
          <div class="section-option">
            <input type="radio" id="kids" name="section" value="Kids" required>
            <label for="kids">Kids</label>
          </div>
          <div class="section-option">
            <input type="radio" id="accessories" name="section" value="Accessories" required>
