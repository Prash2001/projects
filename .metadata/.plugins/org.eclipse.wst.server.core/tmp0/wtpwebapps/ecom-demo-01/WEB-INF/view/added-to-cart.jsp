...
<body>
    <div class="message-container">
        ...
        <p>Thank you for choosing our product. It has been successfully added to your cart.</p>
        <div class="button-container">
            <button class="button" onclick="javascript:history.go(-1)">Go Back</button>
            <button class="button go-back" onclick="window.location.href='${pageContext.request.contextPath}/cart/fetchCart';">Go to Cart</button>
        </div>
    </div>
</body>
</html>
