...
<body>
	<div class="modal">
		...
		<div class="text-wrapper">
			...
			<p>We will pass wishlist attribute in the model and show product details here</p>
			<button class="button button-no" onclick="window.location.href='${pageContext.request.contextPath}/product/getProducts?section=All';">Go Back</button>
			<button class="button button-yes" onclick="window.location.href='${pageContext.request.contextPath}/user/addWishListItem';">Go To WishList</button>
		</div>
	</div>
</body>
</html>
